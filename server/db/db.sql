...
VALUES
  ...
  (UUID_TO_BIN(UUID()),'Grace Miller', '1970-06-08', '2023-03-07 23:45:00', '2023-03-08 00:00:00', 2, 1, 'AFUERA', 'Sore throat', 'Medication 10', 2, 1),
  ...
  (UUID_TO_BIN(UUID()),'Jack Wilson', '1972-10-10', '2023-03-22 06:00:00', '2023-03-22 06:15:00', 2, 1, 'EN AISLAMIENTO', 'Knee pain', 'Medication 13', 1, 2);